...
5. Open **AI Risk Lab**.
6. Select **Rahul Kumar** and click **Run prediction**.
...
The seeded Rahul Kumar has a wearable vital record and a hypertension condition, so the AI screen has real data to explain.
